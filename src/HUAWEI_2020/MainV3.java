...
//			System.out.println(Arrays.toString(item.toArray()));
            ...
            Object[] cyArray = item.toArray();
            int iMax = cyArray.length-1;
            b.append(cyArray[0]);
...
//							System.out.println(""+g.dot[searchDot]+"开始接收子链,子链的条目有："+subChainSet.size());
                            for(LinkedList<Integer> subChain:g.chainSet[des]) {
                                if(count-subChain.size()>=0&&!subChain.contains(g.dot[searchDot])) {
...
//		String filePath = "test_data.txt";
        String filePath = "E:\\华为软挑2020\\HWcode2020-TestData-master\\testData\\test_data.txt";
//		String filePath = "E:\\华为软挑2020\\test_data.txt";
